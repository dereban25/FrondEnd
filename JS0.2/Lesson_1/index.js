...
document.querySelector('.three').innerHTML = '<h3>test</h3>';
// 	Task 11.
...
document.querySelector('.four').innerHTML = '<h4>Somethings</h4>';
document.querySelector('.four').innerHTML += '<p>New paragraph</p>';
// Task 12.
...
const a = document.querySelector('.five').innerHTML = 3.1415;
// 	Task 13.
...
const div7 = document.querySelector('.seven').innerHTML = '<img src="https://cdn4.iconfinder.com/data/icons/food-and-drink-flat-gradient/32/cone_ice_cream_food_drink_sweet-512.png" alt="">';
// 	Task 14.
...
let d2 = console.log(document.querySelector('.test-2'));
d2 =5;
console.log(d2);
...
let divs3 = console.log(document.querySelector('.s3'));
divS3 = console.log(document.querySelector('.s4'));
