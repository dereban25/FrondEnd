...
function f1() {
	let inputText = document.querySelector('.i-1').value
	d1.push(inputText);
	showArr('.out-1', d1);
}
...
function f4() {
	let inText4 = document.querySelector('.i-4').value;
	d1.push(inText4);
	showArr('.out-4', d1);
}
...
function f5() {
	let inText5 = document.querySelector('.i-5').value;
	d1.unshift(inText5);
	showArr('.out-5', d1);
}
...
function f6() {
	let inText6 = document.querySelector('.i-6').value;
	d6[(d6.length - 1)] += ' ' + inText6;
	showArr('.out-6', d6);
}
...
function f8() {
	let inputText8 = document.querySelector('.i-8').value;
	d8.splice(0, 0, inputText8);
	showArr('.out-8', d8);
}
...
// что количество элементов равно введенному числу, и каждый элемент равен 1.
...
function f14() {
	let len = document.querySelector('.i-14').value;
	let value = 1;
	for (len; len > 0; len--) {
		d14.push(value);
	}
...
function f18() {
	let ch18 = document.querySelector('.i-18').value
	document.querySelector('.out-18').innerHTML = d18.includes(ch18);
}
...
// Результат выводит в .out-20. В качестве разделителя укажите два апострофа без пробела.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
