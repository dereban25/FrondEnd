...
// Task 2
// При нажатии b-2 выполняете функцию f2. Функция должна вывести в out-2 значение hi из массива a2.
...
// Task 3
// При нажатии b-3 выполняете функцию f3. Функция должна вывести в out-3 значение my из массива a3.
// Возвратите это значение.


function f3() {
	let a3 = [[1, 2, 3], [3, 4, 5], [6, [7, 'my']]];
	return document.querySelector('.out-3').innerHTML = a3[2][1][1];
...
// Функция должна вывести в out-4 значение go из массива a4.
// Возвратите это значение.


function f4() {
	let a4 = [[1, 2, 3], 'go', [3, 4, 5], [6, [7, 'my']]];
	return document.querySelector('.out-4').innerHTML = a4[1];
}
...
function f6() {
	...
	for(let k = 0;k<a6.length;k++){
		if(a6[k][0]%2!==0) out+= a6[k][0] + ' ';
		if(a6[k][1]%2!==0) out+= a6[k][1] + ' ';
	}
...
function f7() {
	...
	for (let i = 0; i < a7.length; i++) {
		for (let k = 0; k < a7[i].length; k++) {
			if (a7[i][k] % 2 === 0) out1 += a7[i][k] + ' ';
		}
	}
	document.querySelector('.out-7').innerHTML = out1;
...
function f8() {
	...
	for (let i = 0; i < a8.length; i++) {
		for (let k = 0; k < a8[i].length; k++) {
			if (a8[i][k] % 2 !== 0) out2 += a8[i][k] + ' ';
		}
	}
	document.querySelector('.out-8').innerHTML = out2;
...
// Все действия в функции f12. Функция запускается при нажатии на b12. Вывод через пробел.
