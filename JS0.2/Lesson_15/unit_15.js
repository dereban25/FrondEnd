...
//  Функция должна вывести в out-5 количество элементов в наборе s5.
...
const f6 = () => {
	let newEl = new Set(a6);
	document.querySelector('.out-6').innerHTML = Array.from(newEl);
}
...
const f7 = () => {
	...
	let newI7 = new Set(i7);
	if (i7.length > 6 && newI7.size === i7.length) {
...
const f9 = our_set => Array.from(our_set).join('_');
