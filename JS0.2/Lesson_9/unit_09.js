...
//  Task 5
// По нажатию b-5 запускайте функцию f5,
// которая проверяет наличие класса bg-4 у блока out-4 (да, именно bg-4 у out-4 ).
...
//  Task 9
// Усложним предыдущие задачи.
// С помощью цикла повесьте на блоки out-9 событие клик.
...
// Функция создает через createElement div c текстом 25 и добавляет его через append в out-11.
...
//  Task 13
// Добавьте кнопку .b-13, которая запускает функцию f13.
// Функция создает через createElement div c текстом pushMe и добавляет ему класс bg-13.
...
function f13() {
	...
	div13.innerHTML = 'Push me';
	div13.className = 'bg-13';
